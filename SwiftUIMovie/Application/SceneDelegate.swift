...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let rootView = RootView(viewModel: RootViewModel(service: NetworkManager()), loginRouter: LoginRouter())
...
//******* FIX *******
// Loading animation missed
// Movie dtail is not using ViewRouter.
// Search "" ""
//.
// Pagination of List.
//Remove - API Key
